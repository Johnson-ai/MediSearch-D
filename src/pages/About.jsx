    ...
    <div className="min-h-screen pt-16 bg-grid bg-medical-pattern">
      <div className="max-w-4xl mx-auto px-4 pt-14 pb-20">
        ...
        <div className="glass border border-blue-800/30 rounded-3xl p-10 md:p-14 mb-14 glow-blue-strong animate-slide-up relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-slate-400 text-base leading-relaxed max-w-xl mb-6">
              This platform was built specifically for Damilare Akossou, a final-year nursing student preparing for her professional qualifying examinations in 2026.
            </p>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <div className="glass border border-blue-900/40 rounded-xl px-4 py-3">
                ...
                <div className="text-white font-semibold">Damilare Akossou</div>
              </div>
              <div className="glass border border-blue-900/40 rounded-xl px-4 py-3">
              ...
              <div className="glass border border-blue-900/40 rounded-xl px-4 py-3">
                ...
                <div className="text-white font-semibold">Claude AI (Anthropic)</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-14 animate-slide-up stagger-2">
          <h2 className="font-display text-2xl font-bold text-white mb-6">What MediSearch AI Covers</h2>
        ...
        <div className="text-center animate-slide-up">
          ...
          <p className="text-slate-700 text-[11px] font-mono mt-5">Damilare Akossou · Nursing Final Year · 2026</p>
        </div>
      </div>
    </div>
  );
